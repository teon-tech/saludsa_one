...
use App\Processes\ShippingAddressProcess;
...
{
    /**
     * @var ShippingAddressProcess
     */
    private $process;

    /**
     * @var ShippingAddressTransformer
     */
    private $transformer;

    /**
     * CustomerController constructor.
     * @param ShippingAddressProcess $process
     * @param ShippingAddressTransformer $transformer
     */
    public function __construct(ShippingAddressProcess $process, ShippingAddressTransformer $transformer)
    {
    ...
    {
        $query = $request->all();
        $data = $this->process->findAll($customer_id, $query);
    ...
    {
        $response = $this->process->getAllByCustomer($customerId,$request);
        return $response;
    }
