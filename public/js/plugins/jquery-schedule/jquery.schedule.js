...
;(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        create: function () {
            ...
            var width = 100;
            var days_length = this.settings.days.length;
            var width_header = 100;
            if (days_length > 0) {
                width_header = width / days_length;
            }
            for (var k = 0; k < this.settings.days.length; k++) {
                $("<div class='jqs-grid-day' style='width: " + width_header + "%'>" + this.settings.days[k] + "</div>").appendTo($(".jqs-grid-head", this.element));
            }
        },
        ...
        openOptions: function (event, period) {
            ...
            if (this.settings.enableOpenOptions === false) {
                return false;
            }
            var $this = this;
            $this.closeOptions();
